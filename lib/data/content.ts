...
export const ugcPosts = [
  { handle: "@maria.k", tint: "#E7D8C9", ratio: "1/1" },
  { handle: "@thecolemanz", tint: "#D9D2C4", ratio: "1/1" },
  { handle: "@luna_and_max", tint: "#DFE0E8", ratio: "1/1" },
  { handle: "@jessbakes", tint: "#E4DABF", ratio: "1/1" },
  { handle: "@old.dog.new.threads", tint: "#E9D9C2", ratio: "1/1" },
  { handle: "@pets.and.co", tint: "#D8E0DC", ratio: "1/1" },
];
